...
public class minMaxAggregate {
	...
	public static void main(String[] args) throws SQLException {
		...
		String data= "select * from employee where esal in (select min(esal) from employee)";
		//String data= "select * from employee where esal in (select max(esal) from employee)";
